...
export const METRICS = {
  ...
  stores_active: {
    ...
    unit: 'count',
    direction: 'up_good',
    formula: 'distinct stores with ≥1 order in trailing 7d',
    source: 'fact_orders × dim_store',
    grain: 'day × store × state',
    description: 'Live stores that actually transacted this week.',
    cadence: '60 min',
  },
  ...
  stores_dark: {
    ...
    unit: 'count',
    direction: 'down_good',
    formula: 'live stores with 0 orders in 7d',
    source: 'fact_store_adoption_daily × dim_store',
    grain: 'day × store × state',
    description: 'Live stores that have gone quiet — the NOC call list.',
    cadence: '60 min',
  },
